Shader "浅墨Shader编程/Volume6/32.凹凸纹理+颜色可调+边缘光照+细节纹理"
{
	...
	SubShader 
	{
		...
		#pragma surface surf Lambert finalcolor:setcolor  //surface:表面着色器，Lambert：使用兰伯特光照模型，finalcolor：最终的颜色函数
		...
		void surf (Input IN, inout SurfaceOutput o) 
		{
			...
			//设置细节纹理
			o.Albedo *= tex2D (_Detail, IN.uv_Detail).rgb * 2;  //为何要乘以2，shader里面的颜色是0-1,个人猜测是因为细节纹理贴图都是灰度图 在128左右。如果不是在128左右，模型会偏暗偏亮。
			//从凹凸纹理获取法线值
